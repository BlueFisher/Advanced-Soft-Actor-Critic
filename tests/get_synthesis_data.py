...
def gen_batch_obs_for_attn(obs_shapes, d_action_size, c_action_size, seq_hidden_state_shape, batch=10):
    ...
    return {
        ...
        'ep_actions': get_action(batch, episode_len, d_action_size, c_action_size),
...
def gen_batch_oc_obs_for_rnn(obs_shapes, d_action_size, c_action_size,
...
def gen_episode_trans(obs_shapes, d_action_size, c_action_size, seq_hidden_state_shape=None, episode_len=None):
    ...
    vanilla_episode_trans = {
        ...
        'l_actions': get_action(1, episode_len, d_action_size, c_action_size),
...
def gen_episode_oc_trans(obs_shapes, d_action_size, c_action_size,
                         num_options=2,
