...
class ModelRep(m.ModelBaseRNNRep):
    def _build_model(self, blur, brightness, ray_random):
        ...
        self.dense = m.LinearLayers(64 * 3, dense_n=128, dense_depth=1, output_size=128)
    ...
    def forward(self, obs_list, pre_action, rnn_state=None, padding_mask=None):
        ...
        # self._image_visual(vis_cam, vis_seg, max_batch=3)
        ...
        x = self.dense(torch.cat([vis_cam, vis_seg, ray], dim=-1))
