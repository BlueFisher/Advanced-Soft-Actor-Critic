...
class ModelRep(m.ModelBaseAttentionRep):
    def _build_model(self):
        ...
        embed_size = NUM_OPTIONS + 1 + 3 * 4  # 16
        ...
        self.rnn1 = m.GRU(embed_size, embed_size, num_layers=1, dropout=0.02)
    ...
    def forward(self, index, obs_list, pre_action=None,
        ...
        if hidden_state is not None:
            ...
            attn_hidden_state = hidden_state[..., :16]
            rnn_1_hidden_state = hidden_state[..., 16:16 + 16]
            attn1_hidden_state = hidden_state[..., 16 + 16:]
